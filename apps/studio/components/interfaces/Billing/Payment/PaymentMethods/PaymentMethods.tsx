import {
	PermissionAction,
	SupportCategories,
} from "@supabase/shared-types/out/constants";
					...
					<div className="sticky space-y-2 top-12">
						...
						<p className="text-sm text-foreground-light mb-2 pr-4 m-0">
							{isStripeManagedOrganization
								? "Billing for this organisation is handled through a connected through Stripe Projects."
				...
				<ScaffoldSectionContent>
					{selectedOrganization && isPartnerBilledOrganization ? (
						...
						<>
							...
							{isError && (
								<AlertError
									subject="Failed to retrieve payment methods"
									error={error as any}
								/>
							)}
												...
												<div className="flex items-center justify-between py-4 px-8">
													{!canUpdatePaymentMethods ? (
														<p className="text-sm text-foreground-light">
															You need additional permissions to manage payment
															methods
														</p>
													) : (
														<div />
